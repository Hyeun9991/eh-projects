  ...
  return (
    <div className="w-full flex items-center justify-around">
      <input
        ...
        className="bg-cs-gray-02/40 text-cs-dark-gray placeholder:text-cs-dark-gray/60 w-5/6 px-3 py-1.5 text-sm rounded-lg outline-none focus:ring-4 ring-cs-gray-02/50"
      />
      <button
        onClick={clickButton}
